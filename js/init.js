...
let mapBlocks = [
    ...
    {x : 0 , y : 250 , height : canvas.height - 250 , width : 30} , // 2
    {x : 0 , y : 0 , height : 200 , width : 30} , // 3

    {x : canvas.width - 30 , y : 0 , height : 200 , width : 30} , // 4
    {x : canvas.width - 30 , y : 250 , height : canvas.height - 250 , width : 30} , // 5

    {x : canvas.width - 30 , y : 250 , height : 20 , width : 30} , // 6

    {x : 100 , y : 80 , height : 40 , width :80} , // 7
    {x : 240 , y : 80 , height : 40 , width :80} , // 8
    {x : canvas.width - 170 , y : 80 , height : 40 , width :80 } , // 9
    {x : canvas.width - 320 , y : 80 , height : 40 , width :80} , // 10
    {x : canvas.width / 2 - 20 , y : 20 , height : 100 , width : 40 } ,// 11

    {x : 100 , y : 160 , height : 30 , width :80} , // 12
    {x : 240 , y : 160 , height : 30 , width :120} , // 13
    {x : canvas.width - 170 , y : 160 , height : 30 , width :80 } , // 14
    {x : canvas.width - 360 , y : 160 , height : 30 , width :120} ,// 15

    {x : 150 , y : 190 , height :100 , width : 30} , // 16
    {x : 630 , y : 190 , height :100 , width : 30} , // 17
    {x : 30 , y : 250 , height : 40 , width : 70} , // 18
    {x : 710 , y : 250 , height : 40 , width : 70} , // 19
    {x : 300 , y : 250 , height : 40 , width : 200} , // 20
    {x : 80 , y : 370 , height : 40 , width : 250 } , // 21
    {x : 480 , y : 370 , height : 40 , width : 250} , //22
    {x : 380 , y : 280 , height :240 , width : 40} , //23

    {x : 220 , y : 250 , height :140 , width : 30 } , //24
    {x : 550 , y : 250 , height :140 , width : 30} , //25
